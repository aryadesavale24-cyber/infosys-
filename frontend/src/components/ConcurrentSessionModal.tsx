...
const ConcurrentSessionModal: React.FC<ConcurrentSessionModalProps> = ({
    isOpen,
    message,
    onForceLogout,
    onCancel,
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 animate-slideUp">
                ...
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
                    <p className="text-sm text-yellow-800">
                        <strong>⚠️ Warning:</strong> Clicking "Force Logout" will terminate your previous session and log you in here. Any unsaved work in the other session will be lost.
                    </p>
                </div>
                ...
                <p className="text-xs text-gray-500 text-center mt-4">
                    This is a security feature to prevent unauthorized access to your account.
                </p>
            </div>
